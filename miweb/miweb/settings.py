...
SECRET_KEY = 'django-insecure-7siul_zlnfdud@ck5cgy=7lj_9z^2%hp)zw$pcv@50tw5j9wsg'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'web.context_processors.fecha_actual',
                'web.context_processors.valor_dolar',
...
EMAIL_HOST_PASSWORD="yhfufyfbatrcdxcn"
